<template>
  <transition name="move">
    <div v-show="showFoodDetail" class="food" ref="food">
      <div class="food-content">
        ...
        <div class="detail">
          ...
          <transition name="fade">
            <div @click.stop.prevent="buy" class="buy" v-show="!food.count || food.count===0">
              加入购物车
            </div>
          </transition>
        </div>
        ...
        <div class="rating">
          ...
          <div class="ratings-wrapper">
            <ul v-if="food.ratings && food.ratings.length">
              <li v-show="calcuteShow(rating.rateType,rating.text)" class="rating-item border-1px"
